export default function MeditationPageSkeleton() {
  return (
    <main className="pb-20 animate-pulse">
      {/* Hero Section Skeleton - Apenas um container */}
      <div className="min-h-[400px] sm:min-h-[500px] md:min-h-[600px] bg-gray-200 rounded-3xl mx-4 sm:mx-6 md:mx-8"></div>

      {/* List Section Skeleton */}
      <div className="mx-auto max-w-4xl px-4 py-6 sm:py-8 md:px-8">
        {/* Header Skeleton */}
