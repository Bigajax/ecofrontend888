...
export function SonoGuestPostFlow({ onCheckout, checkoutLoading, onDismiss }: SonoGuestPostFlowProps) {
  ...
  const advance = (to?: Step) => setStep(s => (to ?? (s + 1)) as Step);
  ...
  return (
    ...
    >
      {/* Progress dots */}
      <div className="absolute top-10 left-0 right-0 flex justify-center gap-1.5">
        ...
        <AnimatePresence mode="wait">
          ...
          {step === 1 && (
            ...
            >
              ...
              <h2 className="font-display text-[26px] font-bold text-white leading-snug mb-10"
              ...
              <div className="flex flex-col gap-3 w-full">
                <button
                  ...
                  style={{ background: 'linear-gradient(135deg, #A78BFA 0%, #6D42C9 100%)', boxShadow: '0 8px 28px rgba(107,79,187,0.45)' }}
                >
                  Sim, relaxei
                </button>
                <button
          ...
          {step === 2 && validation && (
            ...
            >
              <motion.p
                ...
                className="font-display text-[38px] font-bold text-white leading-none mb-5"
                ...
                {NIGHTS_2_7.map((night, idx) => (
                  ...
                  >
                    <div
                      ...
                      style={{
                        background: idx === 0 ? 'rgba(167,139,250,0.20)' : 'rgba(255,255,255,0.06)',
                        border: idx === 0 ? '1px solid rgba(167,139,250,0.35)' : '1px solid rgba(255,255,255,0.10)',
                      }}
                    >
                      <Lock
                        className="h-2.5 w-2.5"
                        style={{ color: idx === 0 ? '#C4B5FD' : 'rgba(255,255,255,0.30)' }}
                      />
                    </div>
                    <div className="flex-1 min-w-0">
                      <span
                        className="text-[10px] font-bold uppercase tracking-wider mr-2"
                        style={{ color: idx === 0 ? 'rgba(196,181,253,0.60)' : 'rgba(255,255,255,0.25)' }}
                      >
                        Noite {night.night}
                      </span>
                      <span
                        className="text-[12px] font-medium"
                        style={{ color: idx === 0 ? 'rgba(255,255,255,0.80)' : 'rgba(255,255,255,0.45)' }}
                      >
                        {night.title}
                      </span>
                    </div>
          ...
          {step === 5 && (
            ...
            >
              <motion.h2
                ...
                className="font-display text-[28px] font-bold text-white leading-snug mb-6"
                style={{ textShadow: '0 2px 24px rgba(0,0,0,0.70)' }}
              >
                A maioria das pessoas<br />
                para{' '}
                <em style={{ color: 'rgba(251,191,36,0.85)', fontStyle: 'italic' }}>exatamente aqui.</em>
              </motion.h2>
              ...
              <motion.div
                ...
                style={{ background: 'rgba(251,191,36,0.30)' }}
              />
              ...
              <motion.button
                ...
                style={{ background: 'linear-gradient(135deg, #A78BFA 0%, #6D42C9 100%)', boxShadow: '0 10px 32px rgba(107,79,187,0.50)' }}
              >
                Não vou parar →
              </motion.button>
            </motion.div>
          ...
          {step === 6 && (
            ...
            >
              ...
              <div
                ...
                style={{ top: '15%', left: '50%', transform: 'translateX(-50%)', width: '280px', height: '180px', borderRadius: '50%', background: 'radial-gradient(ellipse, rgba(124,58,237,0.18) 0%, transparent 70%)', filter: 'blur(40px)' }}
              />

              {/* Night progress: 1 done + 6 locked */}
              <div className="flex items-center gap-1.5 mb-6 relative z-10">
                <div
                  ...
                  style={{ background: 'linear-gradient(135deg, #C4B5FD 0%, #7C3AED 100%)', boxShadow: '0 0 12px rgba(124,58,237,0.60)' }}
                >
                  ✓
                </div>
              ...
              <h2
                className="font-display text-[22px] font-bold text-white leading-snug mb-4 relative z-10"
              ...
              {/* Price */}
              <div className="flex items-baseline justify-center gap-2.5 mb-1 relative z-10">
                <span className="text-[13px] line-through" style={{ color: 'rgba(255,255,255,0.25)' }}>R$97</span>
                <span className="font-display text-[36px] font-bold text-white leading-none">R$37</span>
              </div>
              <p className="text-[12px] mb-3 relative z-10" style={{ color: 'rgba(255,255,255,0.32)' }}>
              ...
              <div className="flex items-center justify-center gap-2 mb-5 relative z-10">
                ...
                <span className="text-[11px]" style={{ color: 'rgba(255,255,255,0.35)' }}>12.400+ pessoas dormem melhor</span>
              </div>
              ...
              <button
                ...
                style={{ background: 'linear-gradient(135deg, #A78BFA 0%, #5A3DB0 100%)', boxShadow: '0 10px 36px rgba(124,58,237,0.60)' }}
              >
                {checkoutLoading ? (
              ...
              {/* Microcopy */}
              <p className="text-[12px] leading-relaxed mb-4 relative z-10" style={{ color: 'rgba(255,255,255,0.35)' }}>
