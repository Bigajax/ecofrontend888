...
/** Lua dourada — mesma assinatura visual da EcoDreamSection, em escala menor. */
function MoonOrb() {
  return (
    <svg width="46" height="46" viewBox="0 0 64 64" fill="none" aria-hidden="true">
      <defs>
        <radialGradient id="ecoDreamBonusMoon" cx="38%" cy="30%" r="68%">
          <stop offset="0%" stopColor="#F5E09A" />
          <stop offset="45%" stopColor="#C9A55A" />
          <stop offset="100%" stopColor="#7A5520" />
        </radialGradient>
      </defs>
      <circle cx="32" cy="32" r="26" fill="url(#ecoDreamBonusMoon)" />
