    ...
    columns: [
      {
        ...
        links: [
          { label: 'Anual · economize 25%', to: '/assinar?step=plan&plan=annual&from=mega_assinaturas_anual' },
          { label: 'Mensal', to: '/assinar?step=plan&plan=monthly&from=mega_assinaturas_mensal' },
        ],
      },
      {
        heading: 'Comunidade',
