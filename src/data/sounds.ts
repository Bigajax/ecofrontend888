...
export const SOUND_CATEGORIES: SoundCategory[] = [
  {
    ...
    sounds: [
      ...
      { id: 'nat_4', title: 'Riacho', duration: '60 min', image: 'url(/images/sounds/riacho.webp)', category: 'natureza', isPremium: false, badge: 'SOM RELAXANTE' },
  ...
  },
  {
    ...
    sounds: [
      { id: 'med_profunda', title: 'Meditação Profunda', duration: '60 min', image: 'url(/images/sounds/meditacao-profunda.webp)', category: 'meditacao', isPremium: false, badge: 'PRINCIPAL', audioUrl: '/sounds/meditacao-profunda.mp3' },
