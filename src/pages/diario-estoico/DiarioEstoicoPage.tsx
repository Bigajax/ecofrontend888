...
export default function DiarioEstoicoPage() {
  ...
  useEffect(() => {
    ...
    // Apply eco-bg
    document.documentElement.setAttribute('style', 'background: var(--bg-primary) !important; background-color: var(--bg-primary) !important;');
    document.body.setAttribute('style', 'background: var(--bg-primary) !important; background-color: var(--bg-primary) !important;');
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'var(--bg-primary)', minHeight: '100dvh', color: 'var(--text-primary)' }}>
      <Toaster position="top-center" />

      <div className="page-with-nav w-full min-h-full">
          ...
          <div className="mx-auto max-w-3xl flex items-center justify-between">
            <button
              ...
              className="inline-flex items-center justify-center w-10 h-10 text-eco-text
                         border border-eco-line/60 rounded-full hover:border-eco-accent/40
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="px-3 py-2.5 transition-colors duration-300"
                            style={{ backgroundColor: isActive ? 'var(--bg-primary)' : 'var(--surface-card)' }}>
